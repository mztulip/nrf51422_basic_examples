...
static void analyse_payload(void)
{
...
void show_pdu_data(int8_t rssi)
{
    ...
    switch(pdu_type)
    {
        case 0 : analyse_payload(); break;
        case 0x2: analyse_payload(); break;
        case 0x4: analyse_payload(); break;
        default: printf("\n\rReceived Not implemented PDU type!!!!");
    }
}